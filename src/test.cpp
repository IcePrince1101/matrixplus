...
TEST(S21MatrixTest, Test_Constructor_Parametrized) {
  ...
  EXPECT_EQ(matrix_1.GetCols(), 200);
}
...
TEST(S21MatrixTest, Test_SetCols_More) {
  S21Matrix matrix_1(2, 2);
  matrix_1(1, 1) = 6.9;

  matrix_1.SetCols(5);
  EXPECT_EQ(matrix_1.GetCols(), 5);
  EXPECT_EQ(matrix_1(1, 1), 6.9);
}

TEST(S21MatrixTest, Test_SetCols_Less) {
  S21Matrix matrix_1(2, 2);
  matrix_1(0, 0) = 6.9;
...
TEST(S21MatrixTest, Test_SetCols_Zero) {
  S21Matrix matrix_1;

  EXPECT_ANY_THROW(matrix_1.SetCols(0));
}
